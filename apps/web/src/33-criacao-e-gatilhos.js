  ...
  function openGenerated(idx){
    ...
    var tabsDef=[["estrategia","Roteiro e estratégia"],["carrossel","Carrossel"],["stories","Stories"]];
  ...
  function renderApprovals(){
    if(genOn()){
      ...
      I("#approvalList").innerHTML=pecasTabelaHtml(g,"Nada aguardando aprovação. Quando a IA escrever uma peça, ela aparece aqui para você aprovar ou pedir ajuste.");
